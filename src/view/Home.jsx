...
export const Home = () => {
  ...
  useEffect(() => {
    console.log("pizza es en Home:" , pizzas)
  }, []);
       ...
       <div className='main'>
         { pizzas.length ? pizzas.map((pizzaCard, key) => (
          <div key={key} className='card'>
            ...
            <h5>ingredientes: </h5>
             <div className='boxIngredients'>{pizzaCard.ingredients.map((ingrediente , key) => (
            ...
            <div className='buttons'>
              <button className='verMas'> ver mas<img src={EyesIcon} alt="imagen de 2 ojos" /></button>
              <button className='añadir'>añadir<img src={ShoppingIcon} alt="imagen de carro de compras" /></button>
            </div>
